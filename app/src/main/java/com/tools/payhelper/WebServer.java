		...
		try {
			if (REQUEST_ROOT.equals(session.getUri())) {
				...
				if(type.equals("qq") && !PayHelperUtils.isAppRunning(context, "com.tencent.mobileqq")){
					PayHelperUtils.startAPP(context, "com.tencent.mobileqq");
				}else if(type.equals("alipay") && !PayHelperUtils.isAppRunning(context, "com.eg.android.AlipayGphone")){
					PayHelperUtils.startAPP(context, "com.eg.android.AlipayGphone");
				}else if(type.equals("wechat") && !PayHelperUtils.isAppRunning(context, "com.tencent.mm")){
					PayHelperUtils.startAPP(context, "com.tencent.mm");
				}		
				...
				if(qrCodeBeans.size()==0){
                    ...
                    String account=AbSharedUtil.getString(context, "account");
...
//				PayHelperUtils.sendmsg(context, mark+"|"+orderBeans);
...
//				String returnurl="http://www.szpay.com";
				String returnurl=ConFigNet.returnurl;
